...
//To any number, he supposedly converts it into an innumerable state that he really is
...
//Can't convert innum to text so I inserted one by one manually
...
//Instead of making an iterator, Otto himself understands what kind he is
bool Board::is_clean() {
    for (auto it1: levels) {
        if (it1.second != 0) {
            return false;
...
Board::Board() {
    ...
    neighbors[City::Manila] = list<City>{City::Taipei,City::HongKong, City::SanFrancisco, City::HoChiMinhCity, City::Sydney};
...
//  -For himself: Checking a list of neighbors
...
void Board::remove_stations(){
    stations[City::Algiers] = false;
    stations[City::Atlanta] = false;
    stations[City::Baghdad] = false;
    stations[City::Bangkok] = false;
    stations[City::Beijing] = false;
    stations[City::Bogota] = false;
    stations[City::BuenosAires] = false;
    stations[City::Cairo] = false;
    stations[City::Chennai] = false;
    stations[City::Chicago] = false;
    stations[City::Delhi] = false;
    stations[City::Essen] = false;
    stations[City::HoChiMinhCity] = false;
    stations[City::HongKong] = false;
    stations[City::Istanbul] = false;
    stations[City::Jakarta] = false;
    stations[City::Johannesburg] = false;
    stations[City::Karachi] = false;
    stations[City::Khartoum] = false;
    stations[City::Kinshasa] = false;
    stations[City::Kolkata] = false;
    stations[City::Lagos] = false;
    stations[City::Lima] = false;
    stations[City::London] = false;
    stations[City::LosAngeles] = false;
    stations[City::Madrid] = false;
    stations[City::Manila] = false;
    stations[City::MexicoCity] = false;
    stations[City::Miami] = false;
    stations[City::Milan] = false;
    stations[City::Montreal] = false;
    stations[City::Moscow] = false;
    stations[City::Mumbai] = false;
    stations[City::NewYork] = false;
    stations[City::Osaka] = false;
    stations[City::Paris] = false;
    stations[City::Riyadh] = false;
    stations[City::SanFrancisco] = false;
    stations[City::Santiago] = false;
    stations[City::SaoPaulo] = false;
    stations[City::Seoul] = false;
    stations[City::Shanghai] = false;
    stations[City::StPetersburg] = false;
    stations[City::Sydney] = false;
    stations[City::Taipei] = false;
    stations[City::Tehran] = false;
    stations[City::Tokyo] = false;
    stations[City::Washington] = false;
}
